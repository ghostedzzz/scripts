...
local Window = Rayfield:CreateWindow({
   Name = "ammo hub",
   LoadingTitle = "welcome to ammo hub.",
   LoadingSubtitle = "made by ghosted with a full heart:)",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = nil, -- Create a custom folder for your hub/game
      FileName = "ammo hub config"
   },
   Discord = {
      Enabled = false,
      Invite = "NCnfjXYPRb", -- The Discord invite code, do not include discord.gg/
      RememberJoins = false -- Set this to false to make them join the discord every time they load it up
   },
   KeySystem = true, -- Set this to true to use our key system
   KeySettings = {
      Title = "ammo hub keysystem",
      Subtitle = "key system",
      Note = "dm ghosted.#4371 for the key:)",
      FileName = "ammo hub's key",
      SaveKey = true,
